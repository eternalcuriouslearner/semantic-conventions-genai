...
| --- | --- |
| gen_ai.operation.name | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.provider.name | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
...
| gen_ai.agent.name | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
...
| gen_ai.request.model | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
...
| Attribute | Supporting Libraries |
| --- | --- |
| gen_ai.conversation.compacted | [openai-agents] |
...
| gen_ai.response.finish_reasons | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.usage.cache_creation.input_tokens | (none) |
| gen_ai.usage.cache_read.input_tokens | (none) |
| gen_ai.usage.input_tokens | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.usage.output_tokens | [autogen], [google-adk], [openai-agents], [pydantic-ai] |

## Opt-In

| Attribute | Supporting Libraries |
| --- | --- |
| gen_ai.input.messages | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.output.messages | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.system_instructions | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
| gen_ai.tool.definitions | [autogen], [google-adk], [openai-agents], [pydantic-ai] |
