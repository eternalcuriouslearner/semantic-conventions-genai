...
| --- | --- |
| gen_ai.operation.name | [a2a-python], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
...
| server.port | [a2a-python], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
...
| server.address | [a2a-python], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
